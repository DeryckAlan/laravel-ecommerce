...
@section('content')
	...
	<div class="py-3 shadow-sm bg-warning border-tmp">
		<div class="container">
			<h6 class="mb-0">
				<a href="{{ url('category') }}">
					Collection
				</a>/
				<a href="{{ url('category' .$products->slug) }}">
					...
					<div class="col-md-8">
						...
						<div class="row mt-2">
							...
							<div class="col-md-9">
								...
								@endif
								<button type="button" class="btn btn-success me-3 addToWishlist float-start">Add to Whishlist <i class="fa fa-heart"></i></button>				
							</div>
						</div>
					</div>
